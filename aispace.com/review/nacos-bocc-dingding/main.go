...
func healthchek() {
	...
	var m2service = [...]string{
		"bocc-consumer-common",
		"bocc-consumer-community",
		"bocc-consumer-system-manager",
		"bocc-consumer-revision-community",
		"bocc-provider-common",
		"bocc-provider-community",
		"bocc-provider-system-manager",
		"bocc-provider-authority",
	}
